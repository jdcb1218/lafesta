...
/* profiles/contrib/droopler/modules/custom/d_p_carousel/templates/field--field-d-p-cs-item-reference.html.twig */
class __TwigTemplate_d8b1c28077c5f1239692eb5d1926171f9727230ffdc12c2bd87afc9f117ec940 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["label_display"] ?? null) == "visually_hidden")) ? ("visually-hidden") : (""))];
        // line 55
        $context["carousel_item_classes"] = [0 => "carousel-item-wrapper", 1 => "list-item-wrapper", 2 => "px-3"];
        // line 61
        echo "
";
        // line 62
        if (($context["label_hidden"] ?? null)) {
            ...
            if (($context["multiple"] ?? null)) {
                // line 64
                echo "    <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "carousel-items-wrapper row"], "method", false, false, true, 64), 64, $this->source), "html", null, true);
                echo ">
      ";
                // line 65
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 71
                    echo "      <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => ($context["carousel_item_classes"] ?? null)], "method", false, false, true, 71), 71, $this->source), "html", null, true);
                    echo ">";
    ...
    ";
            ...
            if (($context["multiple"] ?? null)) {
                // line 78
                echo "      <div class='carousel-items-wrapper row'>
    ";
            }
            // line 80
            echo "    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 81
                echo "      <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 81), "addClass", [0 => ($context["carousel_item_classes"] ?? null)], "method", false, false, true, 81), 81, $this->source), "html", null, true);
                echo ">";
...
";
    ...
    {
        return "profiles/contrib/droopler/modules/custom/d_p_carousel/templates/field--field-d-p-cs-item-reference.html.twig";
    }
    ...
    {
        return array (  141 => 86,  137 => 84,  134 => 83,  123 => 81,  118 => 80,  114 => 78,  112 => 77,  106 => 76,  101 => 75,  97 => 73,  86 => 71,  81 => 70,  77 => 68,  66 => 66,  62 => 65,  57 => 64,  54 => 63,  52 => 62,  49 => 61,  47 => 55,  45 => 51,  44 => 49,  42 => 45,  41 => 44,  40 => 43,  39 => 41,);
    }

    public function getSourceContext()
    {
        return new Source("", "profiles/contrib/droopler/modules/custom/d_p_carousel/templates/field--field-d-p-cs-item-reference.html.twig", "/Library/WebServer/Documents/lafesta/web/profiles/contrib/droopler/modules/custom/d_p_carousel/templates/field--field-d-p-cs-item-reference.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 41, "if" => 62, "for" => 65);
